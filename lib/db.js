...
function getPendingDepositsForDev(devId) {
  cache = load();
  return Object.values(cache.pendingDeposits || {}).filter((p) => p.devId === devId);
}
...
module.exports = {
  ...
  // pending deposits
  savePendingDeposit, getPendingDeposit, getPendingDepositsForDev, deletePendingDeposit,
  // settings
